...
## Project Files (in Claude Project)

| File | Description |
| --- | --- |
| `Aaro_Ardis__Retreats__Playshops.pdf` | General retreats & playshops overview |
| `Aaro_Ardis__Playshop_on_Future_of_Love_for_EYTB.pdf` | "The Future of Love" playshop (4 Pillars) — written for Skirt Club |
...
## Playshop Offerings (Known)

1. **Higher Love** — Divine Masculine, Feminine, Theminine & Reverence in Intimacy
2. **Open Relationships & The Future of Love** — Polyamory, ENM & Social Evolution
3. **The Future of Love** — The Four Pillars of the Modern Relationship Revolution (written for Skirt Club / EYTB)
...
## Standing Preferences (from Claude Reference File)
